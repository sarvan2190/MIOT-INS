create VIEW vairReferencedomainAA_v1_missed    
as        
SELECT         
(        
select        
...
where rd.domaincode  in('BLOOD','RITRACE','RIPOS','MB003','AURNC','APERN','PUSCL','REECT','Exam','LABPN','DIRSEM','CTRGR','STYPHI','GRAMSMEAR','AFBSMEAR','FUNGLSMEAR','HANGSMR','CLNCNT','CLTRCMNTS','MISPEC','RPRVALUE','TITERVALUE','BBPN','BBGRP','','MCUM'
,'MCUP','MCUR')      
for json path)as x 